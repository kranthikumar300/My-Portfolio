...
const Contact = () => {
    ...
    return(
        <div className= "pt-10 space-y-10 overflow-x-hidden">
           ...
           <motion.p
            ...
            viewport={{once : true}}
            className="text-lg mt-15 text-center flex flex-wrap justify-center">Feel free to connect with me through Gmail or LinkedIn <br />
